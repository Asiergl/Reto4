...
public class AnadirAudio extends JPanel {

    private static final long serialVersionUID = 1L;

    public AnadirAudio(GestorVentanas f) {
        setSize(567, 385);
        ...
        JButton btnAadirCanciones = new JButton("Añadir");
        btnAadirCanciones.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int respuesta = seleccion.showOpenDialog(AnadirAudio.this);
                if (respuesta == JFileChooser.APPROVE_OPTION) {
                    File archivoSeleccionado = seleccion.getSelectedFile();
                    File destino = new File("C:\\DATOS\\PROG\\eclipse\\Reto4\\canciones", archivoSeleccionado.getName());
